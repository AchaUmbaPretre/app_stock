...
const Information30joursMoney = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const { data } = await axios.get(`${DOMAIN}/api/rapport/venteTotal/totalJour30`);
      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            const { data } = await axios.get(`${DOMAIN}/api/depenses/depense30jours`);
...
export default Information30joursMoney